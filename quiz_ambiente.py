...
# ✅ Função movida para o topo (antes de ser chamada)
...
st.markdown('<div style="margin-top:20px; text-align:center; color:#2f6b3f;">Desenvolvido como ferramenta educativa e de conscientização. 🌿</div>', unsafe_allow_html=True)
